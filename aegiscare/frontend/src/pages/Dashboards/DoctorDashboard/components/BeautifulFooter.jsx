...
import { Stethoscope, Sparkles, ChevronRight, ShieldCheck, PhoneCall, Mail, Award as AwardIcon, Database } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                  ...
                  <div className="md:col-span-1">
                    <div className="flex items-center gap-3 mb-4">
                      <div className={`p-3 rounded-2xl ${
                        isDarkMode ? 'bg-gradient-to-r from-blue-950/40 to-cyan-950/30' : 'bg-gradient-to-r from-blue-100 to-cyan-100'
                      }`}>
                        <Stethoscope className={`w-8 h-8 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} />
                      </div>
                      <div>
                        <h2 className={`text-xl font-bold ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
                          Aegis<span className="text-blue-500">Care</span> 
                        </h2>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {[
                        { label: 'Patient Management', module: 'patients' },
                        { label: 'Telemedicine', module: 'dashboard' },
                        { label: 'E-Prescriptions', module: 'prescriptions' },
                        { label: 'Lab Reports', module: 'lab-reports' },
                        { label: 'Medical Analytics', module: 'analytics' }
                      ].map((item, index) => (
                        <li key={index}>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {[
                        { label: 'Real-time Monitoring', module: 'alerts' },
                        { label: 'AI Diagnostics', module: 'analytics' },
                        { label: 'Secure Video Calls', module: 'dashboard' },
                        { label: 'Digital Prescriptions', module: 'prescriptions' },
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-center gap-3">
                        ...
                        <div>
                          <p className={`text-sm font-medium ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>24/7 Medical Support</p>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div>
                      <p className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>
                        © 2025 AegisCare Pro. All rights reserved. 
