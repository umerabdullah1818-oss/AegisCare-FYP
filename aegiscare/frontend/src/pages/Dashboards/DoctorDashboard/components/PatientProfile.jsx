              ...
              <form onSubmit={async (e) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input name="medName" required placeholder="e.g., Metformin, Amlodipine..."
                  ...
                  {rxType === 'Other' && (
                    <div className="md:col-span-2 animate-fade-in">
                      ...
                      <input name="customType" required placeholder="Enter the specific disease or condition..."
                        className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-300 focus:ring-2 focus:ring-emerald-500/30 font-medium ${
                          isDarkMode ? 'bg-gray-800/60 border-gray-700 text-gray-100 focus:border-emerald-500 placeholder:text-gray-600' : 'bg-white border-gray-200 text-gray-900 focus:border-emerald-500 placeholder:text-gray-400'
                        }`} />
                    </div>
                  ...
                  <div>
                    ...
                    <input name="dosage" required placeholder="e.g., 500mg, 10ml..."
                      className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-300 focus:ring-2 focus:ring-emerald-500/30 font-medium ${
                        isDarkMode ? 'bg-gray-800/60 border-gray-700 text-gray-100 focus:border-emerald-500 placeholder:text-gray-600' : 'bg-white border-gray-200 text-gray-900 focus:border-emerald-500 placeholder:text-gray-400'
                      }`} />
                  </div>
                  ...
                  <div>
                    ...
                    <input name="scheduledTime" required placeholder="e.g., 8:00 AM, After meals..."
                      className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-300 focus:ring-2 focus:ring-emerald-500/30 font-medium ${
                        isDarkMode ? 'bg-gray-800/60 border-gray-700 text-gray-100 focus:border-emerald-500 placeholder:text-gray-600' : 'bg-white border-gray-200 text-gray-900 focus:border-emerald-500 placeholder:text-gray-400'
                      }`} />
                  </div>
                  ...
                  <div>
                    ...
                    <input name="notes" placeholder="Take with food, avoid sunlight..."
                      className={`w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-300 focus:ring-2 focus:ring-emerald-500/30 font-medium ${
                        isDarkMode ? 'bg-gray-800/60 border-gray-700 text-gray-100 focus:border-emerald-500 placeholder:text-gray-600' : 'bg-white border-gray-200 text-gray-900 focus:border-emerald-500 placeholder:text-gray-400'
                      }`} />
                  </div>
              ...
              <form onSubmit={async (e) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea name="followupNotes" rows="2" placeholder="Reason for follow-up appointment..."
