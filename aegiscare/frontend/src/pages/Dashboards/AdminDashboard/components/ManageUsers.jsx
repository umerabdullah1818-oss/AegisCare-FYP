        ...
        <div className="flex-1 min-h-0 overflow-y-auto">
          <div className="p-6 space-y-5">
            ...
            {formData.role === 'doctor' && (
              <div className={`p-4 rounded-xl border ${isDarkMode ? 'bg-emerald-900/10 border-emerald-900/30' : 'bg-emerald-50 border-emerald-100'} space-y-4`}>
                ...
                <div>
                  ...
                  <input type="text" name="licenseNumber" value={formData.licenseNumber} onChange={handleChange} placeholder="License ID"
            ...
            <div className="min-w-0">
              ...
              <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="user@example.com" autoComplete="off"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="min-w-0">
                ...
                <input type="password" name="password" value={formData.password} onChange={handleChange} placeholder="Default: AegisCare123!" autoComplete="new-password"
