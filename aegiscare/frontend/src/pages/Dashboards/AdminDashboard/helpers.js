...
export const getGradient = (color) => {
  const gradients = {
    blue: 'from-blue-500 to-cyan-500', emerald: 'from-emerald-500 to-teal-500',
    purple: 'from-purple-500 to-violet-500', amber: 'from-amber-500 to-orange-500',
    rose: 'from-rose-500 to-pink-500', indigo: 'from-indigo-500 to-blue-500',
    cyan: 'from-cyan-500 to-teal-500', green: 'from-green-500 to-emerald-500'
  };
